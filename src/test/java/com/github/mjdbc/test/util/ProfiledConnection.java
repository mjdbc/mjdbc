...
public class ProfiledConnection implements Connection {
    ...
    public int nCommits;
    public int nRollbacks;

    ProfiledConnection(@NotNull Connection c) {
        this.c = c;
    }
    ...
    public PreparedStatement prepareStatement(String sql) throws SQLException {
        return new ProfiledPreparedStatement(c.prepareStatement(sql));
    }
    ...
    public PreparedStatement prepareStatement(String sql, int[] columnIndexes) throws SQLException {
        return new ProfiledPreparedStatement(c.prepareStatement(sql, columnIndexes));
    }

    @Override
    public PreparedStatement prepareStatement(String sql, String[] columnNames) throws SQLException {
        return new ProfiledPreparedStatement(c.prepareStatement(sql, columnNames));
    }
